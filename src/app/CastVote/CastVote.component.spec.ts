...
describe('CastVoteComponent', () => {
  ...
  let mockCastVoteService;
  let mockDataService

  beforeEach(async(() => {

    mockCastVoteService = sinon.createStubInstance(CastVoteService);
    mockCastVoteService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: CastVoteService, useValue: mockCastVoteService },
