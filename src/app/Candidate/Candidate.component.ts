...
export class CandidateComponent implements OnInit {
  ...
  pastExperience = new FormControl('', Validators.required);
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'one.xord.svoting.Candidate',
      'cgpa': this.cgpa.value,
      'semester': this.semester.value,
      'pastExperience': this.pastExperience.value,
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceCandidate.updateParticipant(form.get('id').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.pastExperience) {
        formObject.pastExperience = result.pastExperience;
      } else {
        formObject.pastExperience = null;
      }
      ...
      if (result.society) {
        formObject.society = result.society;
      } else {
        formObject.society = null;
      }
